...
const AuthPage = () => {
  ...
  return (
    ...
    className="flex items-center   justify-center min-h-[90dvh] bg-gradient-to-br from-white to-red-100 p-4">
      <AnimatePresence>
        <motion.div
          layout
          ...
          className="flex flex-row  min-h-[350px] rounded-xl relative  shadow-lg "
        >
